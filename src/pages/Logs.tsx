...
const SOURCE_LABEL: Record<string, string> = {
  ...
  // Retired, kept so historical log rows still resolve to a name.
  "remind-nonresponders": "Non-Responder Reminders",
  "remind-tier-1": "Tier 1 Non-Responder Reminders",
  "remind-tier-2": "Tier 2 Non-Responder Reminders",
  "remind-tier-3": "Tier 3 Non-Responder Reminders",
  "escalate-tier-2": "Tier 2 Escalation",
  "escalate-tier-3": "Tier 3 Escalation",
  "staffing-catchup": "Staffing Catch-Up",
